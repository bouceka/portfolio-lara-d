...
export const GalleryDetail = () => {
  ...
  return (
    <>
      <SuperSEO
        title={`${galleryType?.toUpperCase()} GALLERY | Lara Drummond Photography`}
        description={`View Lara Drummond Photography's latest projects in one of her areas of specialty: ${galleryType?.toUpperCase()} PHOTOGRAPHY.`}
      />
      <div className="page">
        <div className="row">
