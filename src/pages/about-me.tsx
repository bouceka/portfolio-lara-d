          ...
          <section className="section-bio">
            <div className="bio-container">
              <div className="bio-text">
                ...
                <p>
                  My passion lies in helping businesses of all sizes and industries
                  elevate their brand presence and share their stories through
                  photography. I love developing and executing a brand&apos;’s creative
                  vision with exceptional custom images, so that business owners can focus
                  on the part they do best: growing their business.
                </p>
                ...
                <p>
                  ...
                  need, such as stylists, makeup artists, set designers, digital
                  marketers, and more. All you need to do is meet me for an incredible
                  shoot day, and show off your incredible new photos!
                </p>

                <p>
                  When booking a photography session with me, I guarantee your business
                  will receive hard-hitting visuals that hit the mark, every time.
                </p>
              </div>
